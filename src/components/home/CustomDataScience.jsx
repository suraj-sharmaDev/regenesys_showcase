  ...
  return (
    <div className={`${styles.programContainer}`} ref={props.refProp}>
      <div className="container">
        <h2 className={styles.commonHeading}>DATA SCIENCE</h2>
      </div>
      <div className={`${styles.carouselContainer} container`}>
        {
          <CustomCarousel settings={settings}>
            {Data.customDataScience.map((d, idx1) => {
              return (
                <div
                  key={d.title}
...
export default CustomDataScience;
